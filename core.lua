...
--- @class MPT_Main: NumyConfig_AceAddon, AceHook-3.0, NumyAceEvent-3.0, AceConsole-3.0
local Main = LibStub('AceAddon-3.0'):NewAddon('Mythic Plus Tweaks', 'AceConsole-3.0', 'AceHook-3.0', 'NumyAceEvent-3.0');
